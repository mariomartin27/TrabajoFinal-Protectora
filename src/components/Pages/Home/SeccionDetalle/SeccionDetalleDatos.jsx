    ...
    <div>
      <div className= "detalleDatos">
       ...
       <div className='detallesespecie'>
         ...
         <img className='fotopatita' src="https://i.pinimg.com/originals/ba/f0/6f/baf06f35c1f7b474b0ab7e54de1a3f3c.png" alt='patita'></img>
         <div className='detalleespecie2'>
         <strong>Especie:</strong> <p>{animals.especie}
        </p></div>
        </div>
        ...
        <div className='detallenacimiento2'>
          <strong>Nacimiento:</strong><p>{animals.nacimiento}
        </p></div>
        </div>
        ...
        <div className='detallesexo2'>
          <strong>Sexo:</strong><p>{animals.sexo}
        </p></div>
        </div>
        ...
        <img className='fotopatita' src="https://i.pinimg.com/originals/ba/f0/6f/baf06f35c1f7b474b0ab7e54de1a3f3c.png" alt='patita'></img>
        <div className='detallesexo2'>
          <strong>Tamaño:</strong><p>{animals.tamaño}
        </p></div>
        </div>
        ...
        <img className='fotopatita' src="https://i.pinimg.com/originals/ba/f0/6f/baf06f35c1f7b474b0ab7e54de1a3f3c.png" alt='patita'></img>
        <div className='detallesexo2'>
          <strong>Peso:</strong><p>{animals.peso} kg
        </p></div>
</div>
        
        
              <div className="personalidad"><strong className='detallepersonalidad'>Personalidad:</strong>
        ...
        <p className= "historia">
          <strong className='detallehistoria'>Historia:</strong> {animals.historia}
        </p>
      </div>
    </div>
  )
